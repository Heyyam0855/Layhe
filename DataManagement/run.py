...
def update_table():
    # Treeview-i yeniləmək üçün funksiya
...
exit_button = tk.Button(form_frame, text="Çıxış et", font=modern_font, bg="#FF5733", fg="white", relief="flat", command=app.quit)
exit_button.grid(row=2, column=2, pady=10, padx=10, sticky="w")
